...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://graph.org/file/aa4e9ee566cf6ede5a069.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://graph.org/file/aa4e9ee566cf6ede5a069.jpg"
          alt="logo"
        />
    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/kingLeech">
          <h2 class="name">Bittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/weebzone/kingLeech"><i class="fab fa-github"></i></a>
        <a href="https://t.me/kingLeech"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
<body>
    ...
    <div class="content">
        <img src="https://graph.org/file/aa4e9ee566cf6ede5a069.jpg" class="image">
        <a href="https://telegram.me/kingLeech" style="text-decoration: none;">
            <button class="button">Join Updates Channel Now</button>
        </a>
    </div>
    <div class="footer">
© 2022-23 kingLeech. All Rights Reserved.
    </div>
</body>
</html>
"""
