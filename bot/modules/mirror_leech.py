...
async def _mirror_leech(client, message, isQbit=False, isLeech=False, sameDir=None, bulk=[]):
    ...
    arg_base = {'link': '', 
                ...
                '-uz1500': False, '-unzip1500': False,
                '-z1500': False, '-zip1500': False,
                '-up': '', '-upload': '',
                '-rcf': '', 
                '-u': '', '-user': '',
                '-p': '', '-pass': '',
    ...
    extract       = args['-e'] or args['-extract'] or args['-uz1500'] or args['-unzip1500'] or 'uz1500' in cmd or 'unzip1500' in cmd
    compress      = args['-z1500'] or args['-zip1500'] or (not extract and ('z' in cmd or 'zip' in cmd))
